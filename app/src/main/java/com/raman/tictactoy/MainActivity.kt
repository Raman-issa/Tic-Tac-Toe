...
import kotlin.system.exitProcess
 ...
 class MainActivity : AppCompatActivity() {
        ...
        if (activplayer==1){
           ...
           if (winner==1 || winner==2){
            ...
            if (winner==1 || winner==2){
                ...
                BtnChoise.text="O"
                BtnChoise.setBackgroundResource(R.color.red)
                activplayer=1
            }
        }
        BtnChoise.isEnabled=false
    ...
    fun checckWinner() {
        ...
        if (winner!=-1){
            if (winner==1){
                Toast.makeText(this,"playe own is winner",Toast.LENGTH_LONG).show()
              }else{
                Toast.makeText(this,"playe tow is winner",Toast.LENGTH_LONG).show()
